...
<img class="thumb" data-original="/Public/information/img/tp/<?php echo ($vo["image"]); ?>" src="/Public/information/img/tp/<?php echo ($vo["image"]); ?>" alt="<?php echo ($vo["title"]); ?>"  style="display: block;">
