...
<div class="content">
  <header class="article-header">
	...
	<div class="article-meta"> <span class="item article-meta-time">
	  ...
	  </span> <span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="联系人：<?php echo ($data["lianxiren"]); ?>"><i class="glyphicon glyphicon-globe"></i> <?php echo ($data["zuozhe"]); ?></span> </div>
  </header>
  ...
  <div class="relates">
	...
	<ul>
	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li><a href="<?php echo U('Home/information/pro',array('id'=>$vo['id']));?>" title="" ><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; ?>
	</ul>
  </div>
</div>
</div>
...
<img class="thumb" data-original="/stell/Public/information/img/tp/<?php echo ($vo["image"]); ?>" src="/stell/Public/information/img/tp/<?php echo ($vo["image"]); ?>" alt="<?php echo ($vo["title"]); ?>"  style="display: block;">
