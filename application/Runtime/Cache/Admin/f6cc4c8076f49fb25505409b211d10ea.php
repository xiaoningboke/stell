...
<form method="post" action="<?php echo U('Admin/Index/exitContact');?>" enctype="multipart/form-data">
<input type="hidden"  name="id" value="<?php echo ($data["img"]); ?>">

<div class="layui-form-item" style="padding-top: 50px">
<div class="layui-form-item">
    <label class="layui-form-label">公司名称</label>
    <div class="layui-input-block">
      <input name="title" lay-verify="title" autocomplete="off" placeholder="请输入公司名称" class="layui-input" type="text" value="<?php echo ($data["title"]); ?>">
    </div>
  </div>
  </div>
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input name="name" lay-verify="required" placeholder="请输入联系人" autocomplete="off" class="layui-input" type="text" value="<?php echo ($data["name"]); ?>">
    </div>
  </div>
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input name="phone" lay-verify="required" placeholder="请输入电话" autocomplete="off" class="layui-input" type="text" value="<?php echo ($data["phone"]); ?>">
    </div>
  </div>
  </div>
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input name="address" lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input" type="text" value="<?php echo ($data["address"]); ?>">
    </div>
  </div>
...
<div class="layui-inline">
 <label class="layui-form-label">内容</label>
    <div class="layui-input-inline">
      <textarea name="info" id="info" style="width:700px;height:500px;"><?php echo ($data["introduction"]); ?></textarea> 
    </div>
  </div>
  </div>
