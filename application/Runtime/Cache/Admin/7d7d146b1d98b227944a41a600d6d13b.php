...
<form method="post" action="<?php echo U('Admin/main/exitimages');?>" enctype="multipart/form-data">
...
<div class="layui-form-item layui-form">
<div class="layui-inline">
 <label class="layui-form-label">资讯大图</label>
    <div class="layui-input-inline">
      <input class="layui-input"  type="file" name="photo[]">
    </div>
  </div>
 <div class="layui-inline">
 <label class="layui-form-label">产品知识</label>
    <div class="layui-input-inline">
       <input class="layui-input"  type="file" name="photo[]">
    </div>
  </div>
