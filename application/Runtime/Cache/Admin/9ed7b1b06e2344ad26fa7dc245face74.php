...
<div class="layui-form" style="margin-top: 20px">
    <a href="<?php echo U('Admin/main/addnewproduct');?>" class="layui-btn layui-btn-warm">添加</a>
                   <table class="layui-table">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td><a href="<?php echo U('Admin/main/exitproduct',array('id'=>$vo['id']));?>">修改</a> | <a href="<?php echo U('Admin/main/delproduct',array('id'=>$vo['id']));?>">删除</a></td>
