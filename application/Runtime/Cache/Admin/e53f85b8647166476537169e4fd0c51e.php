...
<form method="post" action="<?php echo U('Admin/main/addproducts');?>" enctype="multipart/form-data">
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input name="lianxifangshi" lay-verify="required" placeholder="请输入联系方式" autocomplete="off" class="layui-input" type="text">
    </div>
  </div>
  </div>
<div class="layui-form-item">
