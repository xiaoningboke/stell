...
<body>
<form method="post" action="<?php echo U('Admin/Index/addconnects');?>">
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input  name="connect" lay-verify="required" placeholder="请输入链接" autocomplete="off" class="layui-input" type="text"><br><br>
    </div>
  </div>
  </div>
