...
<div class="layui-form" style="margin-top: 20px">
    <a href="<?php echo U('Admin/index/addarticle');?>" class="layui-btn layui-btn-warm">添加</a>
                   <table class="layui-table">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$vo): if($vo[kind]==1) $kind="新闻资讯"; else $kind="钢管知识"; ?>
                          <tr>
                            ...
                            <td><a href="<?php echo U('Admin/index/exitartidecon',array('id'=>$vo['id']));?>">修改</a> | <a href="<?php echo U('Admin/index/delArtide',array('id'=>$vo['id']));?>">删除</a></td>
