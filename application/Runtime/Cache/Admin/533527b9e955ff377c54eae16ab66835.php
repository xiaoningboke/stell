...
<form method="post" action="<?php echo U('Admin/Index/exitartidecons');?>" enctype="multipart/form-data">
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input name="zuozhe" lay-verify="required" placeholder="请输入作者" autocomplete="off" class="layui-input" type="text" value="<?php echo ($data["zuozhe"]); ?>">
    </div>
  </div>
  <div class="layui-inline ">
  <label class="layui-form-label">类型</label>
    <div class="layui-input-block">
      ...
      <select name="kind" lay-filter="aihao">
        <option value="1" id="one" selected ="">新闻资讯</option>
        <option value="2" id="two" selected ="">钢管知识</option>
      </select>
              <script type="text/javascript">
               var s = document.getElementById("kinds").value;
               if(s===1){
                document.getElementById("one").selected = "selected";
              }else{
                document.getElementById("two").selected = "selected";
               }
